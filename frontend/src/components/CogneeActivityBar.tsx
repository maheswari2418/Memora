...
export default function CogneeActivityBar({ activities }: Props) {
  ...
  return (
    <div style={{
      ...
      <span style={{ fontSize: 10, color: '#484F58', fontFamily: 'Geist Mono, monospace', flexShrink: 0, marginRight: 4 }}>
        Cognee:
      </span>
      {activities.length === 0 && (
        ...
        {last6.map(act => (
          <motion.div
            ...
            style={{
              ...
              border: `1px solid ${opBorder[act.operation] || '#202124'}`,
              borderRadius: 100,
              padding: '3px 10px',
              flexShrink: 0,
              whiteSpace: 'nowrap',
